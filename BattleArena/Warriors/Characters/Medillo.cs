...
namespace BattleArena.Warriors.Characters
{
    public class Medillo : Warrior, IHealCaster
    {
        ...
        public Medillo(int health, int attackPower, int speed, int healingAmount, TeamType teamType)
            : base("Medillo", health, attackPower, speed, WarriorType.Magery, teamType)
        {
